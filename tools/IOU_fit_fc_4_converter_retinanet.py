...
saved_pth = torch.load('../work_dirs/iou_fit_fc_4/iter_5930000.pth')
...
for k, v in saved_state_dict.items():
    ...
    elif k == 'bottle2.fc3.weight':
        new_state.update({'bbox_head.IOUfit.bottle2.fc3.weight': v})
    elif k == 'bottle2.fc3.bias':
        new_state.update({'bbox_head.IOUfit.bottle2.fc3.bias': v})
    ...
    elif k=='bottle3.fc3.weight':
        new_state.update({'bbox_head.IOUfit.bottle3.fc3.weight': v})
    elif k=='bottle3.fc3.bias':
        new_state.update({'bbox_head.IOUfit.bottle3.fc3.bias': v})
    ...
    elif k == 'bottle4.fc3.weight':
        new_state.update({'bbox_head.IOUfit.bottle4.fc3.weight': v})
    elif k == 'bottle4.fc3.bias':
        new_state.update({'bbox_head.IOUfit.bottle4.fc3.bias': v})
    ...
    elif k == 'fc6.layers.0.weight':
        new_state.update({'bbox_head.IOUfit.fc6.layers.0.weight': v})
    elif k == 'fc6.layers.0.bias':
        new_state.update({'bbox_head.IOUfit.fc6.layers.0.bias': v})


#torch.save(new_state, '../work_dirs/iou_fit_conv_7/iou_fit_conv_retinanet.pth')

# # for old pytorch version to load:
torch.save(new_state, '../work_dirs/iou_fit_fc_4/iou_fit_fc_retinanet.pth', _use_new_zipfile_serialization=False)
