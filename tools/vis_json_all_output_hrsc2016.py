...
vis_root = '/media/yyw/607ca214-10cb-4af6-af97-eac656e135d1/yyw/yyf/Dataset/HRSC2016/vis/IOUfit_retinanet_obb_r50_fpn_6x_hrsc2016_1'
...
for file in pred_list:
    pred_dict = {classes[i]: [] for i in range(1)}
    ...
    img = draw_poly_detections(img_path, detections, classes, colormap=colormap, showStart=True, putText=True)
