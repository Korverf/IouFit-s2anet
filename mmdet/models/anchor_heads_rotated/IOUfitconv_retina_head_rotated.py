...
from mmdet.models.utils import IOUfitConv9
from mmdet.ops import obb_overlaps
import torch

@HEADS.register_module
class IOUfitConvRetinaHeadRotated(AnchorHeadRotated):
    ...
    def __init__(self,
        ...
        super(IOUfitConvRetinaHeadRotated, self).__init__(
            num_classes, in_channels, anchor_scales=anchor_scales, anchor_angles=anchor_angles, **kwargs)
        self.IOUfit = IOUfitConv9(in_features=16, hidden_features=16)
