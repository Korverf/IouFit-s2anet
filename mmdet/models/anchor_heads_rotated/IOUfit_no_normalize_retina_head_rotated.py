...
class IOUfitNoNormalizeRetinaHeadRotated(AnchorHeadRotated):
    ...
    def __init__(self,
        ...
        super(IOUfitNoNormalizeRetinaHeadRotated, self).__init__(
    ...
    def loss_single(self, cls_score, bbox_pred, anchors, labels, label_weights,
        ...
        if pos_inds.any():
            ...
            pos_poly_target = pos_poly_target / 600
            pos_poly_pred = pos_poly_pred / 600
            #归一化
