...
class IOUfitCascadeS2ANetHead(nn.Module):
    ...
    def __init__(self,
        ...
        super(IOUfitCascadeS2ANetHead, self).__init__()
    ...
    def loss_single(self,
        ...
        if pos_inds.any():
            ...
            pos_poly_target, pos_poly_pred = rotated_box_to_poly(pos_bbox_target), rotated_box_to_poly(
                pos_bbox_pred)
