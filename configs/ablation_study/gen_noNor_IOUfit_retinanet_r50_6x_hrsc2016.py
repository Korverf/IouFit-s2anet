...
model = dict(
    ...
    neck=dict(
        ...
        num_outs=5),
    bbox_head=dict(
        type='IOUfitNoNormalizeRetinaHeadRotated',
        num_classes=2,
        in_channels=256,
        stacked_convs=4,
        feat_channels=256,
...
work_dir = 'work_dirs/gen_noNor_IOUfit_retinanet_r50_6x_hrsc2016_1'
load_type = 'retinanet'
# load_iou_fit_module = './work_dirs/iou_fit_module_49/iou_fit_module_retinanet.pth'
load_iou_fit_module = './work_dirs/iou_fit_module_51/iou_fit_module_retinanet.pth'
log_level = 'INFO'
load_from = None
resume_from = None
workflow = [('train', 1)]
