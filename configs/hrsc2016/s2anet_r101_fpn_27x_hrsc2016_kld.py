...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_fam_cls=dict(
            ...
            alpha=0.25,
            loss_weight=1.0),
        loss_fam_bbox=dict(type='GDLoss', loss_type='kld', tau=1.0, representation='xy_wh_r',
                       loss_weight=2.0),
        loss_odm_cls=dict(
            type='FocalLoss',
            use_sigmoid=True,
            ...
            alpha=0.25,
            loss_weight=1.0),
        loss_odm_bbox=dict(type='GDLoss', loss_type='kld', tau=1.0, representation='xy_wh_r',
                       loss_weight=2.0)))
...
log_level = 'INFO'
work_dir = 'work_dirs/s2anet_r101_fpn_27x_hrsc2016_kld'
