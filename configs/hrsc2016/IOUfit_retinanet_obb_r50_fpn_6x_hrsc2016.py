...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_cls=dict(
            ...
            alpha=0.25,
            loss_weight=1.0),
        loss_bbox=dict(type='FitIoULoss', loss_weight=1.0)))
...
data_root = '/media/yyw/607ca214-10cb-4af6-af97-eac656e135d1/yyw/yyf/Dataset/HRSC2016/'
img_norm_cfg = dict(
...
data = dict(
    ...
    test=dict(
        ...
        pipeline=test_pipeline))
evaluation = dict(
    gt_dir='/media/yyw/607ca214-10cb-4af6-af97-eac656e135d1/yyw/yyf/Dataset/HRSC2016/Test/Annotations/',
    imagesetfile='/media/yyw/607ca214-10cb-4af6-af97-eac656e135d1/yyw/yyf/Dataset/HRSC2016/Test/test.txt')
# optimizer
...
work_dir = 'work_dirs/IOUfit_retinanet_obb_r50_fpn_6x_hrsc2016_1_rerun_2'
load_type = 'retinanet'
# load_iou_fit_module = './work_dirs/iou_fit_module_49/iou_fit_module_retinanet.pth'
load_iou_fit_module = './work_dirs/iou_fit_module_49_rerun/iou_fit_module_retinanet.pth'
log_level = 'INFO'
load_from = None
resume_from = None
workflow = [('train', 1)]
