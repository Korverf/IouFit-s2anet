...
model = dict(
    ...
    neck=dict(
        ...
        num_outs=5),
    bbox_head=dict(
        type='IOUfitConvRetinaHeadRotated',
        num_classes=2,
        in_channels=256,
        stacked_convs=4,
        feat_channels=256,
...
work_dir = 'work_dirs/IOUfit_conv7_retinanet_obb_r50_fpn_6x_hrsc2016_1'
load_type = 'retinanet'
load_iou_fit_module = './work_dirs/iou_fit_conv_7/iou_fit_conv_retinanet.pth'
log_level = 'INFO'
load_from = None
resume_from = None
workflow = [('train', 1)]
