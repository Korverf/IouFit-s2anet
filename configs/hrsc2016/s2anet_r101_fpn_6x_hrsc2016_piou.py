...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_fam_cls=dict(
            ...
            alpha=0.25,
            loss_weight=1.0),
        loss_fam_bbox=dict(type='PIoULoss', loss_weight=0.5, img_size=800),
        loss_odm_cls=dict(
            type='FocalLoss',
            use_sigmoid=True,
            gamma=2.0,
            alpha=0.25,
            loss_weight=1.0),
        loss_odm_bbox=dict(type='PIoULoss', loss_weight=0.5, img_size=800)))
...
log_level = 'INFO'
work_dir = 'work_dirs/s2anet_r101_fpn_6x_hrsc2016_piou_2'
