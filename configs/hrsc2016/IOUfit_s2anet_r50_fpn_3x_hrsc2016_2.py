...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_fam_cls=dict(
            ...
            alpha=0.25,
            loss_weight=1.0),
        loss_fam_bbox=dict(type='FitIoULoss', loss_weight=1.0),
        loss_odm_cls=dict(
            type='FocalLoss',
            use_sigmoid=True,
            gamma=2.0,
            alpha=0.25,
            loss_weight=1.0),
        loss_odm_bbox=dict(type='FitIoULoss', loss_weight=1.0)))
...
log_level = 'INFO'
work_dir = 'work_dirs/IOUfit_s2anet_r50_fpn_3x_hrsc2016_2'
load_type = 's2anet'
