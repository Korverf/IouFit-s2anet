    ...
    bbox_head=[
        dict(
            ...
            loss_cls=dict(
                ...
                loss_weight=1.0),
            loss_bbox=dict(
                type='FitIoULoss', loss_weight=0.5)),
        dict(
            type='IOUfitCascadeS2ANetHead',
            num_classes=2,
            in_channels=256,
...
log_level = 'INFO'
work_dir = 'work_dirs/IOUfit_cascade_s2anet_2s_r50_fpn_6x_hrsc2016_2'
load_type = 'cs2anet_2s'
load_iou_fit_module = './work_dirs/iou_fit_module_49/iou_fit_module_cs2anet2s.pth'
load_from = None
resume_from = None
workflow = [('train', 1)]
