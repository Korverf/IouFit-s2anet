...
model = dict(
    ...
    bbox_head=dict(
        ...
        anchor_angles=[0., ], # more angles lead to a mAP improvement.
...
data_root = '/home/yyw/yyf/Dataset/DOTA-1.0/dataset_split_1024_gap200/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'trainval1024/trainval_s2anet.pkl',
    ...
    test=dict(
        type=dataset_type,
        ann_file=data_root + 'test1024/test_s2anet.pkl',
...
work_dir = 'work_dirs/IOUfit_retinanet_obb_r50_fpn_2x_dota_1'
