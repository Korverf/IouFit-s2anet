...
def main():
    ...
    annopath = r'/home/yyw/yyf/Dataset/HRSC2016/Test/labelTxt/{:s}.txt'  # change the directory to the path of val/labelTxt, if you want to do evaluation on the valset
    imagesetfile = r'/home/yyw/yyf/Dataset/HRSC2016/Test/test.txt'
...
def parse_args():
    ...
    parser.add_argument('--detpath', type=str, default='/home/yyw/yyf/projects/s2anet/work_dirs/s2anet_r101_fpn_3x_hrsc2016/results_txt/ship.txt',
